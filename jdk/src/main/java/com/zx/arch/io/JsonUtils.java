...
public final class JsonUtils {
    ...
    @SuppressWarnings("fb-contrib:PSC_SUBOPTIMAL_COLLECTION_SIZING")
    public static <T> Map<String, T> convertToMap(LinkedHashMap<String, Object> linkedHashMap, Class<T> tClass) {
        if(linkedHashMap == null) {
            ...
            while (iter.hasNext()) {
                ...
                result.put((String)entry.getKey(), mapper.convertValue(entry.getValue(), tClass));
            }
            return result;
        }
    }
